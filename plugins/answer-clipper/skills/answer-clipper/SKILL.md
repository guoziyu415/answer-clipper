---
name: answer-clipper
description: Open and use the Answer Clipper workspace when the user wants to collect, annotate, organize, or export useful excerpts without extending the conversation for each edit.
---
