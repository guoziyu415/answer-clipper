...
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Privacy Policy — Answer Clipper</title><meta name="description" content="How Answer Clipper handles selected text, annotations, local notes, and optional Google Docs saving."><link rel="canonical" href="https://guoziyu415.github.io/answer-clipper/privacy.html"><link rel="icon" href="assets/icon-32.png"><link rel="stylesheet" href="styles.css"></head>
<body><a class="skip" href="#main">Skip to content</a><header class="site-header wrap"><a class="brand" href="./"><img src="assets/icon-128.png" width="40" height="40" alt="">Answer Clipper</a><nav aria-label="Main navigation"><a href="./">Home</a><a href="https://github.com/guoziyu415/answer-clipper">GitHub ↗</a></nav></header><main id="main" class="wrap policy">${renderPolicy(policy)}</main><footer class="wrap site-footer"><span>Answer Clipper</span><a href="./">Back to home</a></footer></body></html>\n`);
