...
- Public support contact: `guoziyu415@gmail.com`, explicitly confirmed by the maintainer. Chrome sent its publisher-email verification link; completion is still pending.
...
- Google Branding now has the homepage, privacy policy and `guoziyu415.github.io` authorized domain. Saving these settings is not ownership verification or OAuth production approval.
